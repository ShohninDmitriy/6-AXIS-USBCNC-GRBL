...
#define DEFAULT_HOMING_PULLOFF 1.5f // mm
		...
		#define DEFAULT_X_STEPS_PER_MM 800.0f					// X axis step per mm // 400
		#define DEFAULT_Y_STEPS_PER_MM 800.0f					// Y axis step per mm
		#define DEFAULT_Z_STEPS_PER_MM 1600.0f					// Z axis step per mm
		...
		#define DEFAULT_B_STEPS_PER_MM 200.0f					// B axis step per mm
#endif
#if defined(ABC_AXIS)
		#define DEFAULT_C_STEPS_PER_MM 200.0f					// C axis step per mm
#endif
		#define DEFAULT_X_MAX_RATE 6000.0f 						// X axis mm/min // 600
		#define DEFAULT_Y_MAX_RATE 6000.0f 						// Y axis mm/min
		#define DEFAULT_Z_MAX_RATE 50.0f 						// Z axis mm/min
#if defined(AA_AXIS) || defined(AB_AXIS) || defined(ABC_AXIS)
...
#endif
		#define DEFAULT_X_ACCELERATION (300.0f*60*60) 			// X axis 10*60*60 mm/min^2 = 10 mm/sec^2 // 45
		#define DEFAULT_Y_ACCELERATION (300.0f*60*60) 			// Y axis 10*60*60 mm/min^2 = 10 mm/sec^2
		#define DEFAULT_Z_ACCELERATION (10.0f*60*60) 			// Z axis 10*60*60 mm/min^2 = 10 mm/sec^2
#if defined(AA_AXIS) || defined(AB_AXIS) || defined(ABC_AXIS)
...
#endif
		#define DEFAULT_X_MAX_TRAVEL 200.0f 					// X axis mm
		#define DEFAULT_Y_MAX_TRAVEL 200.0f 					// Y axis mm
		#define DEFAULT_Z_MAX_TRAVEL 40.0f 					// Z axis mm
#if defined(AA_AXIS) || defined(AB_AXIS) || defined(ABC_AXIS)
		...
		#define DEFAULT_SPINDLE_RPM_MAX 1000.0f 				// rpm
		#define DEFAULT_SPINDLE_RPM_MIN 0.0f 					// rpm
		#define DEFAULT_STEP_PULSE_MICROSECONDS 2 				// usec
		#define DEFAULT_STEPPING_INVERT_MASK 0x0
		#define DEFAULT_DIRECTION_INVERT_MASK 0x5
		#define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 				// msec (0-254, 255 keeps steppers enabled)
