...
//#define SPINDLE_PWM_MIN_VALUE 38 // Default disabled. Uncomment to enable. Must be greater than zero. Integer (1-255).
...
#define PARKING_TARGET -2.0f // Parking axis target. In mm, as machine coordinate [-max_travel,0].
